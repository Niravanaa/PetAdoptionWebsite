...
const About = () => {
  return (
    ...
    <motion.p className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]" variants={fadeIn("", "", 0.1, 1)}>
      I am a versatile software developer skilled in various environments and programming languages, including web development with CSS, HTML, and Bootstrap 5, and game development using the Unity Engine.
    </motion.p>
